...
public class Q01OutcomeTest {
	...
	public void test26EnsureCapacityNeedsToGrow() {
		...
		assertTrue(message(NEED_CURRENT, ACTION, DESCRIPTION), sequence.isCurrent());
		assertEquals(message(WRONG_CURRENT, ACTION, DESCRIPTION), 5.0, sequence.getCurrent(), EPSILON);
		assertEquals(message(WRONG_CAPACITY, ACTION, DESCRIPTION), 25, sequence.getCapacity());
	...
	public void test37AddAllParameterEmpty() {
		...
		sequence.addAfter(3.0);
		sequence.addBefore(7.0);
		ArrayDoubleSequence addend = new ArrayDoubleSequence();
	...
	public void test40Clone() {
		...
		sequence.addAfter(5.0);
		DoubleSequence copy = sequence.clone();
		assertTrue("Clone of an ArrayDoubleSequence should be an ArrayDoubleSequence.", copy instanceof ArrayDoubleSequence);
		ArrayDoubleSequence clone = (ArrayDoubleSequence)copy;
		...
		assertEquals("Cloning should not have changed original's capacity.", 10, sequence.getCapacity());
