...
long double fcyc(test_funct f, void* argp);
 ...
 *     Default = 1<<19 (512KB)
 */
void set_fcyc_cache_size(unsigned bytes);

/*
 * set_fcyc_cache_block - Set size of cache block
 *     Default = 32
 */
void set_fcyc_cache_block(unsigned bytes);
 ...
 *     Default = 20
 */
void set_fcyc_maxsamples(unsigned maxsamples_arg);

/*
 * set_fcyc_epsilon - Tolerance required for K-best
 *     Default = 0.01
 */
void set_fcyc_epsilon(long double epsilon_arg);
